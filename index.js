...
//imports enquirer for user prompting
...
//How many guesses remain for user
var guesses = 9;
//Used to check for win
var wordCheckArr;
//Used to check for win
var wordCheck;
//Used to check if the user already guessed a letter this word
var guessedLetters = [];

//Function to get the word from the word list array
...
//Word selected is sent to word constructor to create the word array and display the letters
function wordGen() {
...
//Function to play the guessing portion
